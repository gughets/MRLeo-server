...
int main(int argc, char *argv[])
{
  ...
  QCoreApplication::setApplicationName("MR-Leo");
  ...
  if (displayOptionEnabled) {
    qDebug() << "*** MR-Leo-server has not been compiled with widget support and can't support parameter --display";
    qDebug() << "*** Enable DISPLAY_MOCK_DATA in MR-Leo-server.pro and rebuild.";
  }
#endif
